...
import { Bell, Star, ChevronDown, SlidersHorizontal, Circle } from 'lucide-react-native';
...
const GROUPS: LeagueGroup[] = [
  {
    ...
    liveLabel: 'Live',
    fixtures: [
      { id: 'ucl-1', home: 'Real Madrid', away: 'Bayern Munich', homeScore: 2, awayScore: 1, status: 'LIVE', minute: "78'", live: true },
      { id: 'ucl-2', home: 'Arsenal', away: 'Atlético Madrid', homeScore: 3, awayScore: 0, status: 'FT' },
    ],
  },
  {
    id: 'epl',
    ...
    liveLabel: 'Live',
    fixtures: [
      { id: 'epl-1', home: 'Manchester City', away: 'Liverpool', homeScore: 1, awayScore: 1, status: 'LIVE', minute: "64'", live: true },
      { id: 'epl-2', home: 'Tottenham', away: 'Chelsea', homeScore: 2, awayScore: 2, status: 'FT' },
    ],
  },
  {
    id: 'laliga',
    ...
    liveLabel: 'Live',
    fixtures: [
      { id: 'll-1', home: 'Barcelona', away: 'Real Sociedad', homeScore: 3, awayScore: 1, status: 'LIVE', minute: "72'", live: true },
      { id: 'll-2', home: 'Real Betis', away: 'Sevilla', homeScore: 1, awayScore: 0, status: 'FT' },
    ],
  },
];
      ...
      <View style={styles.rowBody}>
        <View style={styles.teamCol}>
          <View style={styles.logoStub}>
            <Text style={styles.logoStubTxt}>{fixture.home.slice(0, 2).toUpperCase()}</Text>
          </View>
        ...
        <View style={styles.teamCol}>
          <View style={styles.logoStub}>
            <Text style={styles.logoStubTxt}>{fixture.away.slice(0, 2).toUpperCase()}</Text>
          </View>
    ...
    <View style={styles.leagueCard}>
      <View style={styles.leagueHead}>
        <View style={styles.leagueLeft}>
          <Circle size={9} fill={group.accent} color={group.accent} />
...
const styles = StyleSheet.create({
  ...
  logoStubTxt: { color: 'rgba(255,255,255,0.88)', fontSize: 11, fontWeight: '800' },
